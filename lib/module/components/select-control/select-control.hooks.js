...
export const useSelectControl = () => {
  ...
  const accessibilityLabel = useMemo(() => isOpened ? '' : (selectContainerProps === null || selectContainerProps === void 0 ? void 0 : selectContainerProps.accessibilityLabel) ?? 'Open a dropdown', [isOpened, selectContainerProps === null || selectContainerProps === void 0 ? void 0 : selectContainerProps.accessibilityLabel]);
